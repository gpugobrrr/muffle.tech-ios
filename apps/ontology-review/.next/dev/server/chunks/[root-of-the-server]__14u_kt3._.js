...
"[project]/app/api/answers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$answer$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/answer-store.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/review.ts [app-route] (ecmascript)");
;
;
;
;
async function reviewerOrUnauthorized() {
    const reviewerId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["currentReviewerId"])();
    return reviewerId;
}
async function GET() {
    const reviewerId = await reviewerOrUnauthorized();
    if (!reviewerId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Unauthorized.'
    }, {
        status: 401
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        answers: await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$answer$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReviewAnswerStore"])().getAnswers(reviewerId)
    });
}
async function PUT(request) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValidQuestionId"])(body?.questionId) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isReviewAnswer"])(body?.answer)) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const answer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$answer$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReviewAnswerStore"])().saveAnswer(reviewerId, {
...
"[project]/data/ontology-review-v1.json.[json].cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/lib/answer-store.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function key(reviewerId, questionId) {
    return `${reviewerId}\u0000${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTION_SET_VERSION"]}\u0000${questionId}`;
}
function createMemoryReviewAnswerStore() {
    ...
    return {
        async getAnswers (reviewerId) {
            return [
                ...answers.entries()
            ].filter(([entryKey])=>entryKey.startsWith(`${reviewerId}\u0000${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTION_SET_VERSION"]}\u0000`)).map(([, answer])=>answer).sort((left, right)=>left.questionId.localeCompare(right.questionId));
        },
...
function postgresStore(databaseUrl) {
    ...
    return {
        ...
        WHERE reviewer_id = ${reviewerId} AND question_set_version = ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTION_SET_VERSION"]}
      ...
      `;
        ...
        VALUES (${reviewerId}, ${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$review$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTION_SET_VERSION"]}, ${answer.questionId}, ${answer.answer}, NOW(), NOW())
...
async function currentReviewerId() {
    return readSession((await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).get(SESSION_COOKIE)?.value);
}
...
"[project]/lib/review.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$ontology$2d$review$2d$v1$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/ontology-review-v1.json.[json].cjs [app-route] (ecmascript)");
;
const QUESTION_SET_VERSION = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$ontology$2d$review$2d$v1$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].version;
const ANSWERS = [
    'yes',
    'no',
    'not-sure'
];
const questions = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$ontology$2d$review$2d$v1$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].questions;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14u_kt3._.js.map