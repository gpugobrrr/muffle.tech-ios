  ...
  children: [
    ...
    externalFindingBranch(externalFindingConfig('walls'), [
      createFindingCaptureLeaf(
        'limit',
        'limitation',
        'Record a finding-scoped limitation for the external walls finding.',
        externalFindingConfig('walls').findingId,
        externalFindingConfig('walls').elementConceptId,
        'limitation',
        'External wall finding limitation',
      ),
      createFindingCaptureLeaf(
        'further',
        'further investigation',
        'Record further investigation required for the external walls finding.',
        externalFindingConfig('walls').findingId,
        externalFindingConfig('walls').elementConceptId,
        'furtherInvestigation',
        'External wall further investigation',
      ),
      createFindingCaptureLeaf(
        'risk',
        'risk',
        'Record a finding-specific risk statement for the external walls finding.',
        externalFindingConfig('walls').findingId,
        externalFindingConfig('walls').elementConceptId,
        'risk',
        'External wall risk',
