...
export const BLOCKED_ROUTE_REASONS: Readonly<Record<string, SurveyBlockedReason>> = {
  ...
  'property/type': SURVEY_BLOCKED_REASONS.missingFieldSemantics,
  'property/age': SURVEY_BLOCKED_REASONS.missingFieldSemantics,
  'property/extension': SURVEY_BLOCKED_REASONS.missingFieldSemantics,
  'property/conversion': SURVEY_BLOCKED_REASONS.missingFieldSemantics,
  ...
  'property/location': SURVEY_BLOCKED_REASONS.missingFieldSemantics,
