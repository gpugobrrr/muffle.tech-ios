...
test('interactive Level 2 routes remain explicitly bounded', () => {
  ...
  assert.deepEqual(interactive, [
    ...
    'external/roof',
    'external/roof/observe',
    'external/roof/condition',
    'external/roof/defect',
    'external/roof/recommend',
    'external/roof/photo',
    'external/roof/evidence',
    'external/rainwater',
    ...
    'external/walls/limit',
    'external/walls/further',
    'external/walls/risk',
    ...
    'external/doors',
    'external/doors/observe',
    'external/doors/condition',
    'external/doors/defect',
